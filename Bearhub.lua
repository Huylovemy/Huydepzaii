...
-- 🟢 Toggle state
-- thiết lập nút bấm mới gọi trực tiếp hàm của menu
...
ToggleButton.Position = UDim2.new(0.12, 0, 0.15, 0) -- Bạn có thể chỉnh vị trí ở đây
ToggleButton.Size = UDim2.new(30,30)
ToggleButton.Image = "rbxassetid://134852113716171" -- Icon của Bear Hub
ToggleButton.Draggable = true -- Cho phép kéo nút

UICorner.CornerRadius = UDim.new(0, 10)
UICorner.Parent = ToggleButton

-- Chức năng gọi trực tiếp hàm của Menu
ToggleButton.MouseButton1Click:Connect(function()
    -- Kiểm tra xem cửa sổ menu (v15) có tồn tại không
    if v15 then
        -- Gọi hàm Minimize của Fluent để đóng/mở trực tiếp
        v15:Minimize() 
    end
end)
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://www.tiktok.com/@huyscriptth?_r=1&_t=ZS-937qEPI4rWD");
    end
});
v16.Home:AddButton({
    Title = "Youtube",
    Description = "Click(Copy)",
    Callback = function()
        setclipboard("https://youtube.com/@ttquanghuy?si=WHejknYpilnQ8Zz5");
    end
});
v16.Home:AddButton({
    Title = "Remember:",
    Description = "This is the real Bear Hub, by Quang Huy.",
    Callback = function()
        setclipboard("https://www.tiktok.com/@huyscriptth?_r=1&_t=ZS-937qEPI4rWD");
    end
});
